...
// markup not found, no include::{specDir}caches/flush/\{name\}/POST/spec.adoc[opts=optional]
...
// markup not found, no include::{snippetDir}caches/flush/\{name\}/POST/http-request.adoc[opts=optional]


// markup not found, no include::{snippetDir}caches/flush/\{name\}/POST/http-response.adoc[opts=optional]



// file not found, no * wiremock data link :caches/flush/{name}/POST/POST.json[]


ifdef::internal-generation[]
===== Implementation

// markup not found, no include::{specDir}caches/flush/\{name\}/POST/implementation.adoc[opts=optional]
